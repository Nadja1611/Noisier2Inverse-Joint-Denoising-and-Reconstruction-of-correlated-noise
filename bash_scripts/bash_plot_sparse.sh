...
python plot_results.py  --angles 512  --path '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Results_Paper_nuts_sparse/' --datadir '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Data/' --outputdir '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Results_Paper_nuts_sparse/' --noise_type "gauss" --dataset 'Nuts' --learning_rate 7e-5 --noise_sigma 2 --noise_intensity 5 --batch_size 4
python plot_results_last.py  --angles 512  --path '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Results_Paper_nuts_sparse/' --datadir '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Data/' --outputdir '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Results_Paper_nuts_sparse/' --noise_type "gauss" --dataset 'Nuts' --learning_rate 7e-5 --noise_sigma 2 --noise_intensity 5 --batch_size 4
python plot_boxplots_results_sparse.py  --angles 512  --path '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Results_Paper_nuts_sparse/' --datadir '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Data/' --outputdir '/gpfs/data/fs72515/nadja_g/Noisier2Inverse/Noisier2Inverse/Results_Paper_nuts_sparse/' --noise_type "gauss" --dataset 'Nuts' --learning_rate 7e-5 --noise_sigma 2 --noise_intensity 5 --batch_size 4
